...
public class TestUsers extends BasicTest {
    ...
    public void createUserWithInvalidData() throws Exception {
    	...
    	// without password
        assertEquals("200 {result: Failed, message: Basic authorization is required}",
        ...
        // correct sign up
        assertEquals("200 {result: OK, message: }",
        		POST("/signup", params, "test", "test"));
        
        // second time the same user
        assertEquals("200 {result: Failed, message: A user with such login already exists}",
        		POST("/signup", params, "test", "test"));
    }
    ...
    public void createUser() throws Exception {
        ...
        assertEquals("200 [{id: 1, firstName: test, lastName: test, role: USER}, {id: 2, firstName: alex, lastName: solovyov, role: ADMIN}]",
        		GET("/users"));
    }
    ...
    public void invalidSignFails() throws Exception {
    	...
    	TreeMap<String, Object> empty = new TreeMap<>();
    	assertEquals("200 {result: Failed, message: Invalid login/password}",
